...
export interface ApiFilmFilm extends Schema.CollectionType {
  ...
  attributes: {
    backdrop_path: Attribute.String;
    cover_path: Attribute.String;
    name: Attribute.String;
    mm_name: Attribute.String;
    rating: Attribute.Decimal;
    released_date: Attribute.String;
    slug: Attribute.UID<'api::film.film', 'name'>;
    ...
    genres: Attribute.Relation<
      ...
      'api::genre.genre'
    >;
    tv_show: Attribute.Boolean & Attribute.DefaultTo<false>;
    download_link: Attribute.Relation<
      'api::film.film',
      'oneToOne',
      'api::download-link.download-link'
    >;
...
export interface ApiGenreGenre extends Schema.CollectionType {
  ...
  attributes: {
    name: Attribute.String;
    slug: Attribute.UID<'api::genre.genre', 'name'>;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
...
export interface ApiSeasonSeason extends Schema.CollectionType {
  ...
  attributes: {
    total_episodes: Attribute.Integer;
